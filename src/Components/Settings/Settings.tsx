...
import {messagesExemplar, messagesType, messageType, startMessageType} from "../../types/messages";
    ...
    return (
        <Box sx={{
            ...
            <Box sx={{minHeight: '80%', mt: 5}}>
                ...
                {messages && messages.map((message: messageType | startMessageType, i: number) => {
