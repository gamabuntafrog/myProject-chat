			...
			<>
				<Modal width='70%' height='90%' buttonPosition='absolute' isModalOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
					<Box sx={{
						...
						<ImageGallery
							showPlayButton={false} startIndex={previewImageIndex} showFullscreenButton={false} fullscreen thumbnailPosition='left' sizes='100px' infinite={false} thumbnailWidth='100%' thumbnailHeight='600px'
							originalWidth='100%'
							items={previewImages?.map((img: File) => {
				...
				<Box sx={{
					...
					pb: 2,
					px: isMobile ? 1 : 2,
					backgroundColor: userStyles.secondBackgroundColor || "#121212",
					zIndex: 100,
