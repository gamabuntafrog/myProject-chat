...
const UserModalInfo: FC<UserModalInfoPT> = ({modalInfo}) => {
    ...
    return (
        <Box display='flex' textAlign='center' flexDirection='column' justifyContent='center'
             position='absolute' sx={{top: `${modalInfo.pageY + 20}px`, left: `${modalInfo.pageX + 20}px`, padding: '20px', backgroundColor: '#0d47a1', zIndex: 100, borderRadius: '5px'}}>
            <Avatar sx={{width: 200, height: 200}} src={`${modalInfo.user.photoURL}`} alt="avatar"/>
